                ...
                <div class="relative group">
                    <button class="details-btn !-z-[1] group">
                        ...
                        <p class="details-container">
                            ...
                            elit. Similique nemo consequatur a accusamus
                            assumenda laborum consequuntur explicabo dolor, odit
                            eligendi voluptate illum itaque accusantium, cumque
                            tenetur cupiditate illo libero dolores!
                        </p>
                    </button>
                </div>
            </div>
